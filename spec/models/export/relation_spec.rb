...
RSpec.describe Export::Relation do
  ...
  context 'given the Export::Invoices::Extract.all_relevant Relation' do
    ...
    it 'writes each invoice to the export' do
      ...
      expect(output_lines.last).to include('SW1P 3ZZ,2018-05-31,3307957,DEP/0008.00032,GITIS Terms and Conditions,'\
      '1,Contracts,Core,,Legal Director/Senior Solicitor,,Hourly,151.09,-0.9,-135.98,,-27.2,,142.99,0.00,0.00,0.00,'\
      'N/A,Time and Material,,,,,,,,,,,,,,,,,,,')
    end
