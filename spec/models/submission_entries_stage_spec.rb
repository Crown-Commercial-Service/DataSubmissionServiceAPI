...
RSpec.describe SubmissionEntriesStage do
  ...
  describe 'sheet scope' do
    let(:sheet_1_entry) { FactoryBot.create(:submission_entries_stages, sheet_name: 'Sheet 1') }
    let(:another_sheet_1_entry) { FactoryBot.create(:submission_entries_stages, sheet_name: 'Sheet 1') }
    let(:sheet_2_entry) { FactoryBot.create(:submission_entries_stages, sheet_name: 'Sheet 2') }
  ...
  describe 'sector scopes' do
    ...
    let!(:home_office_entry) { FactoryBot.create(:submission_entries_stages, customer_urn: home_office.urn) }
    let!(:health_dept_entry) { FactoryBot.create(:submission_entries_stages, customer_urn: health_dept.urn) }
    let!(:bobs_charity_entry) { FactoryBot.create(:submission_entries_stages, customer_urn: bobs_charity.urn) }
