...
RSpec.describe Workday::CustomerInvoice do
  ...
  before do
    ...
    stub_request(:get, 'https://wd3-impl-services1.workday.com/ccx/service/customreport2/tenant/INT003_ISU/CR_Customer_Invoice_API?Customer_Invoice!WID=WORKDAY_REFERENCE#1')
  ...
  describe '#invoice_details' do
    ...
    context 'when the workday API returns a 500 status code' do
      it 'raises an error' do
        stub_request(:get, 'https://wd3-impl-services1.workday.com/ccx/service/customreport2/tenant/INT003_ISU/CR_Customer_Invoice_API?Customer_Invoice!WID=WORKDAY_REFERENCE#2')
          .with(headers: { 'Authorization' => 'Basic dXNlcjpwYXNzd29yZA==' })
