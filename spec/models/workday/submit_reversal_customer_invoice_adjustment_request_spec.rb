...
RSpec.describe Workday::SubmitReversalCustomerInvoiceAdjustmentRequest do
  ...
  let(:request) { Workday::SubmitReversalCustomerInvoiceAdjustmentRequest.new(submission) }
