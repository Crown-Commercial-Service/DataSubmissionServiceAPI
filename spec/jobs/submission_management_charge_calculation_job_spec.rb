...
RSpec.describe SubmissionManagementChargeCalculationJob do
  describe '#perform' do
    ...
    let!(:invoice_entry_1) { FactoryBot.create(:invoice_entry, submission: submission, total_value: 1235.99) }
    let!(:invoice_entry_2) { FactoryBot.create(:invoice_entry, submission: submission, total_value: 123.45) }
    let!(:order_entry) { FactoryBot.create(:order_entry, submission: submission, total_value: 123.45) }
