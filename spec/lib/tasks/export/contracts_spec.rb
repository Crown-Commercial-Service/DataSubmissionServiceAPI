  ...
  context 'no args are given' do
    ...
    it 'writes a header to that output' do
      expect(output_lines.first).to eql(
        ...
        'ProductLevel6,CustomerContactName,CustomerContactNumber,CustomerContactEmail,ContractStartDate,ContractEndDate'
      )
    end
    ...
    it 'writes each contract to that output' do
      ...
      expect(output_lines[1]).to eql(
        ...
        '#MISSING,#MISSING,#MISSING,#MISSING,#MISSING,#MISSING,#MISSING,#MISSING,#MISSING,6/27/18,6/27/20'
      )
    end
    ...
    it 'writes #NOTINDATA for fields it cannot map' do
      expect(output_lines[2]).to eql(
        ...
        '#MISSING,#MISSING,#MISSING,#MISSING,#MISSING,#MISSING,#MISSING,#MISSING,#MISSING,#NOTINDATA,#NOTINDATA'
      )
    end
