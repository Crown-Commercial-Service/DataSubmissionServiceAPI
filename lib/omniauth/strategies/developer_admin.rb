  ...
  module Strategies
    ...
    class DeveloperAdmin
      ...
      def request_phase
        ...
        # Override our global Content-Security-Policy response header, to
        # permit the inline <style> generated by OmniAuth::Form.
        form.to_response.tap do |response|
          response[1].merge!('Content-Security-Policy' => "default-src self; style-src self 'unsafe-inline'")
        end
      end
