  ...
  module Definition
    class RM1070 < Base
      ...
      class Invoice < EntryData
        ...
        field 'Invoice Price Excluding Options', :string, exports_to: 'Additional8', ingested_numericality: true
        field 'List Price Excluding Options', :string, ingested_numericality: true
