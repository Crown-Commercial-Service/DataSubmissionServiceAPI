...
- Try [increasing the Sidekiq memory usage](#options-for-a-sticking-plaster-fix) and see if we can succesfully ingest the aforementioned [large file](#when-its-happened)
