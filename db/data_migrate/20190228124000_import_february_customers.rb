...
# Execute with:
#
#   rails runner db/data_migrate/20190228124000_import_february_customers.rb
#
require 'csv'
require 'progress_bar'

puts 'Reading CSV file...'
customers_csv_path = Rails.root.join('db', 'data_migrate', '20190228124000_import_february_customers.csv')
